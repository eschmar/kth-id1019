...
out(Str) -> io:format("> ~s.~n", [Str]).

out(Str, black) -> io:format("> ~s.~n", [color:black(Str)]);
out(Str, red) -> io:format("> ~s.~n", [color:red(Str)]);
out(Str, green) -> io:format("> ~s.~n", [color:green(Str)]);
out(Str, yellow) -> io:format("> ~s.~n", [color:yellow(Str)]);
out(Str, blue) -> io:format("> ~s.~n", [color:blue(Str)]);
out(Str, magenta) -> io:format("> ~s.~n", [color:magenta(Str)]);
out(Str, cyan) -> io:format("> ~s.~n", [color:cyan(Str)]);
out(Str, white) -> io:format("> ~s.~n", [color:white(Str)]);
out(Str, default) -> io:format("> ~s.~n", [color:default(Str)]).